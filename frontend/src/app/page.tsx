            ...
            <div className="bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-sm rounded-3xl p-8 md:p-10 mb-12 border border-white/10 hover:border-purple-500/30 transition-all duration-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="group bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl p-8 border border-purple-500/30 hover:border-purple-400/60 transition-all duration-500 hover:scale-105 hover:shadow-purple-500/20">
                  ...
                  <div className="relative group cursor-pointer" onClick={() => openModal('/target-property.png')}>
                    <img src="/target-property.png" alt="Target Property" className="w-full h-40 object-cover rounded-lg mb-4 transition-all duration-300 group-hover:scale-105" />
                ...
                <div className="group bg-gradient-to-br from-pink-500/20 to-purple-500/20 rounded-2xl p-8 border border-pink-500/30 hover:border-pink-400/60 transition-all duration-500 hover:scale-105 hover:shadow-pink-500/20">
                  ...
                  <div className="relative group cursor-pointer" onClick={() => openModal('/ai-powered-search.png')}>
                    <img src="/ai-powered-search.png" alt="AI Powered Search" className="w-full h-40 object-cover rounded-lg mb-4 transition-all duration-300 group-hover:scale-105" />
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex items-center justify-center">
                      <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" />
                      </svg>
                ...
                <div className="group bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-2xl p-8 border border-blue-500/30 hover:border-blue-400/60 transition-all duration-500 hover:scale-105 hover:shadow-blue-500/20">
                  ...
                  <div className="relative group cursor-pointer" onClick={() => openModal('/make-guess.png')}>
                    <img src="/make-guess.png" alt="Make Guess" className="w-full h-40 object-cover rounded-lg mb-4 transition-all duration-300 group-hover:scale-105" />
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex items-center justify-center">
                      <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" />
                      </svg>
                ...
                <div className="group bg-gradient-to-br from-green-500/20 to-purple-500/20 rounded-2xl p-8 border border-green-500/30 hover:border-green-400/60 transition-all duration-500 hover:scale-105 hover:shadow-green-500/20">
                  <div className="text-green-300 text-4xl mb-4 group-hover:scale-110 transition-transform duration-300">4️⃣</div>
                  <h3 className="text-white font-bold text-lg mb-3">Win Medals</h3>
                  <div className="relative group cursor-pointer" onClick={() => openModal('/won-medal.png')}>
                    <img src="/won-medal.png" alt="Won Medal" className="w-full h-40 object-cover rounded-lg mb-4 transition-all duration-300 group-hover:scale-105" />
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex items-center justify-center">
                      <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" />
                      </svg>
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">Achieve your goal and earn medals based on your accuracy within 30% tolerance!</p>
                </div>
              </div>
            </div>
